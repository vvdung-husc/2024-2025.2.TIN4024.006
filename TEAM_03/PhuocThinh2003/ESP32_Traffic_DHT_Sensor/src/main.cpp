...
#define BLYNK_TEMPLATE_ID "TMPL6OjlpOLSU"
#define BLYNK_TEMPLATE_NAME "thinh"
#define BLYNK_AUTH_TOKEN "D7Ntn_Rkw5qCEgvVSZqmC8ZmHMNAolgf"
...
void loop() {  
  ...
  static ulong lastDHTRead = 0;
    if (currentMiliseconds - lastDHTRead > 2000) { // Đọc cảm biến mỗi 2 giây
