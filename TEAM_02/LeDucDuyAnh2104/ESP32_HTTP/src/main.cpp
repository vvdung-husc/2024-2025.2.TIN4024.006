...
#define BLYNK_TEMPLATE_ID "TMPL69gmWpoKa"
#define BLYNK_TEMPLATE_NAME "ESP32 HTTP"
#define BLYNK_AUTH_TOKEN "L1qLla80xsuDQM9wxXoGEnsn0RHW-s-y"
...
const char* API_KEY = "9cc89a3146d60337a9d1d03376da7492";
void requestAPI();
...
void upTime(){
    ...
    if (currentMillis - previousMillis >= interval) {
        ...
        float uptimeSeconds = millis() / 1000.0;  
